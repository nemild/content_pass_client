...
/***/ function(module, exports, __webpack_require__) {
	...
	function postPageview(url, multiplier, successCallback, failureCallback) {
	  var userInitiated = arguments.length <= 4 || arguments[4] === undefined ? false : arguments[4];
	...
	var _default = (function () {
	  ...
	  _createClass(_default, [{
	    ...
	    value: function updateAllTopUrlsForProviders() {
	      var providerListInit = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
	...
	var _default = (function () {
	  ...
	  _createClass(_default, [{
	    ...
	    value: function urlInTop(url) {
	      ...
	      for (var i = 0, _length = urlRepresentations.length; i < _length; i++) {
...
/***/ function(module, exports) {
	...
	var REDDIT_PROVIDER_RELATIVE_URL = '/top.json?sort=top&show=all&limit=';
